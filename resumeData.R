...
# Work Experience
mlSpec <- c('As Machine Learning (ML) specialist, I support the creation of a central ML function within EA.',
            'I leverage domain technical skills and experience managing stakeholders to advise on core principles and roadmap for the team.',
...
snrAnlMngr <- c('As Senior Analytics Manager, I was responsible for the duties of my prior role (Analytics Manager), with further strategic priorities.',
                 'Outomes included migration and centralisation of legacy infrastructure and data warehouse (Hadoop) to Cloud (Snowflake).',
...
anlMngr <- c('As Analytics Manager, I was responsible for the analytics team embedded within EA Melbourne (5 analysts and engineers).',
...
skills <- tribble(
  ...
  'People', 'People Management, Stakeholder Engagement, Coaching, Advocacy',
